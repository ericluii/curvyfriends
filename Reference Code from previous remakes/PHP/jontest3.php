...
function submitForm(formData){
	...
	$.ajax({    
		type: 'POST',
		url : 'parts/statistics_graph.php',        
		data: formData,
		dataType: 'json',
		cache: false,
		beforeSend: function() {
		...
		success: function(data) { 
			//$("#stats").html("<p>UserName="+data.userName+" userID="+data.userID+" friend="+data.friendName+" friendID="+data.friendID+" myPosts="+data.myPosts+" friendPosts="+data.friendPosts+"</p>");
			$("#stats").html("<p>UserName="+data.userName+" userID="+data.userID+" friend="+data.friendName+" friendID="+data.friendID+"</p>");
		},  
		error : function () {
			$("#report-loading").fadeOut(500);
			$('#generalError').show();
        ...
        success: function(data) { 
            ...
            //$("#graphArea").html(data);
            $("#stats").show();
            //$("#stats").html("<p>UserName="+data.userName+" userID="+data.userID+" friend="+data.friendName+" friendID="+data.friendID+" myPosts="+data.myPostCount+"</p>");
            $("#stats").html("<p>UserName="+data.userName+"</p>");
            $("#stats").append("<p>userID="+data.userID+"</p>");
            $("#stats").append("<p>My Posts on Friend's Wall: "+data.myPostCount+"</p>");
            $("#stats").append("<p>My Comments on Friend's Wall: "+data.myCommentCount+"</p>");
            $("#stats").append("<p>My Friend's Posts on my Wall: "+data.myfriendPosts+"</p>");
            $("#stats").append("<p>My Friend's Comments on my Wall: "+data.myfriendComments+"</p>");
